...
var RegionsService = (function () {
    function RegionsService(coordinatesService, http) {
        var _this = this;
    ...
    RegionsService.prototype.getRegions = function (latitude, longitude) {
        ...
        this.http.get(url).pipe(catchError(this.handleError('getRegions', {}))).subscribe(function (data) {
            if (data.admin) {
...
var PlacesService = (function () {
    function PlacesService(coordinatesService, http) {
        var _this = this;
        this.coordinatesService = coordinatesService;
        this.http = http;
    ...
    PlacesService.prototype.getPlaces = function (latitude, longitude) {
        var _this = this;
        var url = this.buildUrl(latitude, longitude);
        this.http.get(url).pipe(catchError(this.handleError('getPlaces', { event: { features: [] } }))).subscribe(function (response) {
